...
public class Contador extends JFrame implements ActionListener {
    ...
    Contador() {
        ...
        lb1 = new JLabel("Caracteres: ");
        lb1.setBounds(50, 50, 100, 20);
        lb2 = new JLabel("Palavras: ");
        ...
        pad = new JButton("Cor do painel");
        pad.setBounds(140, 320, 110, 30);// x,y,w,h
        pad.addActionListener(this);

        text = new JButton("Cor do texto");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == b) {
            ...
            lb1.setText("Caracteres: " + text.length());
            String words[] = text.split("\\s");
            lb2.setText("Palavras: " + words.length);
        } else if (e.getSource() == pad) {
            Color c = JColorChooser.showDialog(this, "Escolha uma cor", Color.BLACK);
            ta.setBackground(c);
